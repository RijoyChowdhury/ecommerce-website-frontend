...
const Register = () => {
    ...
    const submitForm = async () => {
        try {
            ...
            const response = await postData('/api/user/register', { name: `${firstName} ${lastName}`, ...formFields });
                        ...
                        <section className='sigin-form flex justify-center'>
                            <div className='form w-[65%] flex flex-col gap-6'>
                                ...
                                <div className="form-group row flex items-baseline gap-2">
                                    ...
                                    <div className='w-[82%] flex flex-col'>
                                        <FormControl sx={{ width: '100%' }} variant="outlined">
                                            <TextField id="outlined-basic" name='firstName' variant="outlined" size="small" onChange={e => handleInput(e)} />
                                        </FormControl>
                                ...
                                <div className="form-group row flex items-baseline gap-2">
                                    ...
                                    <div className='w-[82%] flex flex-col'>
                                        <FormControl sx={{ width: '100%' }} variant="outlined">
                                            <TextField id="outlined-basic" name='lastName' variant="outlined" size="small" onChange={e => handleInput(e)} />
                                        </FormControl>
                                        <span>Only letters and the dot (.) character, followed by a space, are allowed.</span>
                                    </div>
                                </div>
                                ...
                                <div className="form-group row flex items-center gap-2">
                                    ...
                                    <div className='w-[82%]'>
                                        <FormControl sx={{ width: '100%' }} variant="outlined">
                                            <TextField id="outlined-basic" name="email" variant="outlined" size="small" onChange={e => handleInput(e)} />
                                        </FormControl>
                                    </div>
                                </div>
                            ...
                            <div className="form-group row flex items-center gap-2">
                                ...
                                <div className="form-group row flex items-center gap-2">
                                    ...
                                    <div className='w-[82%]'>
                                        <FormControl sx={{ width: '100%' }} variant="outlined">
                                            <TextField id="outlined-basic" name="password" type={showPassword ? 'text' : 'password'} variant="outlined" size="small"
                                                slotProps={{
                                                    input: {
                                                        endAdornment: (
                                ...
                                <div className="form-group row flex items-center gap-2">
                                    ...
                                    <div className='w-[82%]'>
                                        <FormControl sx={{ width: '100%' }} variant="outlined">
                                            <TextField id="outlined-basic" type={showConfirmPassword ? 'text' : 'password'} variant="outlined" size="small"
                                                slotProps={{
                                                    input: {
                                                        endAdornment: (
                                                            <InputAdornment position="end">
